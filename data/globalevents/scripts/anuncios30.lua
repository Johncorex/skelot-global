local messages = {
	...
	"Atenção: EVITEM usar senhas de outros servidores aqui no Skelot. Jogadores estão sendo hackeados por este motivo e, se o número de casos for muito alto, será impossível ajudar a todos.",
